...
revoke execute on function public.create_user_problem_with_timezone(text, text, text, text, text, text, text, text, date, text) from public;
revoke execute on function public.create_user_problem_with_timezone(text, text, text, text, text, text, text, text, date, text) from anon;
grant execute on function public.create_user_problem_with_timezone(text, text, text, text, text, text, text, text, date, text) to authenticated;
