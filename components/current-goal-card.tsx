        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-sm leading-6 text-zinc-600 dark:text-zinc-400">
              Soon you&apos;ll be able to set an interview date, roadmap, and
              weekly commitment. For now, keep adding and reviewing problems.
            </p>
          </div>
          ...
          <div className="grid gap-2 sm:grid-cols-2 lg:w-[28rem]">
            {futureFields.map((field) => (
              <div
                key={field}
                className="rounded-md border border-dashed border-zinc-200 bg-zinc-50/70 px-3 py-2 dark:border-zinc-800 dark:bg-zinc-950/50"
              >
